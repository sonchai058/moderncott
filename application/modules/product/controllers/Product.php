...
class Product extends MX_Controller {
	...
	public function product_management() {
		...
		$crud->columns('P_Img', 'P_IDCode', 'P_Name', 'PS_Price', 'PS_Amount', 'C_ID', 'PT_ID', 'P_Type');
		...
		$crud->add_fields('P_Img', 'P_Name', 'P_IDCode', 'C_ID', 'PT_ID', 'PU_ID', 'P_Size', 'P_Title', 'P_Detail', 'P_UserAdd', 'P_DateTimeAdd', 'P_UserUpdate', 'P_DateTimeUpdate', 'P_Allow', 'P_Type');
        $crud->edit_fields('P_Img', 'P_Name', 'P_IDCode', 'C_ID', 'PT_ID', 'PU_ID', 'P_Size', 'P_Title', 'P_Detail', 'P_UserUpdate', 'P_DateTimeUpdate', 'P_Allow', 'P_Type');
		...
		$crud->field_type('P_Type', 'dropdown', array('1' => 'ปกติ', '2' => 'สั่งตัด'));
		...
		$crud->callback_field('P_Type', array($this, 'field_callback_P_Type'));
	...
	public function field_callback_P_Type($value = '', $primary_key = null) {
		return '<select id="field-P_Type" name="P_Type"><option disabled>เลือกประเภท</option><option value="1" selected>ปกติ</option><option value="2">สั่งตัด</option></select>';
	}
