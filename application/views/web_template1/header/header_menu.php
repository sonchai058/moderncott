...
<div class="wrap_head_menu">
	...
	<ul class="wrap_nav">
		...
		<li title="สินค้า">
			<a href="<?php echo base_url('main/products_view'); ?>" <?php if (uri_seg(1) == 'main' && (uri_seg(2) == 'products_view' || uri_seg(2) == 'product_details' || uri_seg(2) == 'category' || uri_seg(2) == 'dressmaking_view' || uri_seg(2) == 'dressmaking_details')) { ?> class="under_hover" <?php } ?>>สินค้า</a>
		</li>
